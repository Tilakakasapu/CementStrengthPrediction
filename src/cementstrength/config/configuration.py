from src.cementstrength import *
...
from cementstrength.entity.config_entity import DataValidationConfig
from cementstrength.entity.config_entity import DataTransformationConfig,ModelTrainerConfig
